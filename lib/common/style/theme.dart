...
class AppTheme {
  ...
  // 课程搜索框的提示文字颜色
  static var appBarSearchTextTip = Colors.grey[500]!;
  static var appBarSearchTextTipColor = Colors.grey[500]!;
  static var commonTipColor = Colors.orange;
  static var greyColor = Colors.grey[500]!;
  static var inverseTextColor = Colors.white;
  static var purchaseTipColor = Colors.red;
